...
if [ -f "src/android_manager/ui/icons/icon-256.png" ]; then
    ...
    cp src/android_manager/ui/icons/icon-256.png "${BUILDROOT}/usr/share/icons/hicolor/256x256/apps/adb-appmanager.png"
elif [ -f "src/android_manager/ui/Adb-appmanager-icon.png" ]; then
    cp src/android_manager/ui/Adb-appmanager-icon.png "${INSTALL_DIR}/"
    cp src/android_manager/ui/Adb-appmanager-icon.png "${BUILDROOT}/usr/share/icons/hicolor/256x256/apps/adb-appmanager.png"
